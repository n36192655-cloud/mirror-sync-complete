-- MIZAN: preserve the previously verified approved-only baseline rule while allowing
-- MANUAL readings without photo. This is a correction to the immediately preceding
-- manual-boundary hardening migration.
...
BEGIN
  ...
  -- Authoritative history: only approved readings become the baseline.
