...
BEGIN
  ...
  -- Evidence binding: a reading may reference only the generated object for its own tenant/client cycle.
...
COMMENT ON FUNCTION public.tg_meter_reading_pipeline_before_insert() IS
  'Single authoritative meter-reading BEFORE INSERT validation: tenant, assignment, evidence binding, authoritative meter number, previous reading, consumption and anomaly status.';
